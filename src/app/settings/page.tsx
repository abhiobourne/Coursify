            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col gap-2">
                        <button className="flex items-center justify-between p-4 rounded-2xl bg-primary/10 text-primary font-bold border border-primary/20 transition-all">
                            <span className="flex items-center gap-3">
                                <User className="w-4 h-4" /> Profile Info
                            </span>
                            <ChevronRight className="w-4 h-4" />
                        </button>
                        <button className="flex items-center justify-between p-4 rounded-2xl hover:bg-card/50 text-muted-foreground font-medium border border-transparent transition-all">
                            <span className="flex items-center gap-3">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-8">
                        {/* Profile Section */}
                        <section className="glass-panel p-8 rounded-3xl border border-border/50 space-y-8">
                        ...
                        <section className="glass-panel p-8 rounded-3xl border border-border/50 space-y-6 relative overflow-hidden group">
